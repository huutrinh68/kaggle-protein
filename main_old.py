...
def main():
    ...
    # test data
    test_files = pd.read_csv("/home/trinhnh1/Documents/kaggle/human-protein/input/sample_submission.csv")

    # train data
    df1 = pd.read_csv("/home/trinhnh1/Documents/kaggle/human-protein/input/train.csv")
    df2 = pd.read_csv("/home/trinhnh1/Documents/kaggle/human-protein/input/external_data/img/train.csv")
